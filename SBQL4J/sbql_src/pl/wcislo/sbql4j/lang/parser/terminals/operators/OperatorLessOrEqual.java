...
public class OperatorLessOrEqual extends Operator {

	public OperatorLessOrEqual(OperatorType type) {
		super(type);
	}
	...
	public <T, V extends TreeVisitor> T accept(OperatorVisitor<T,V> opVisitor, V treeVisitor, Expression opExpr, Expression[] subExprs) {
		return opVisitor.visitLessOrEqual(this, treeVisitor, opExpr, subExprs);
	};	
...
//		
//		gen.printExpressionTrace("//OperatorLessOrEqual - start\n");
...
//		}
//		gen.printExpressionTrace("//OperatorLessOrEqual - end\n");	
//	}
