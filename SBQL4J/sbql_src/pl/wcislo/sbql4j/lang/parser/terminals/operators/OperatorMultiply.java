...
public class OperatorMultiply extends pl.wcislo.sbql4j.lang.parser.terminals.Operator {

	public OperatorMultiply(OperatorType type) {
		super(type);
	}
	...
	public <T, V extends TreeVisitor> T accept(OperatorVisitor<T,V> opVisitor, V treeVisitor, Expression opExpr, Expression[] subExprs) {
		return opVisitor.visitMultiply(this, treeVisitor, opExpr, subExprs);
	};	
