...
public class CodeGenNoQres extends CodeGenerator {

	private List<JCSbqlExpression> qTrees = new ArrayList<JCSbqlExpression>();
	private StringBuilder sb;

	public CodeGenNoQres(CodeGenTypeDB4O db4oCodeGenType) {
	...
	public String generateQueriesClass(int queryIndex, List<JCImport> imports) {
		...
		QueryCodeGenNoQres queryPretty = new QueryCodeGenNoQres(this);
