...
package sbql4jx.lang.model.element;
 ...
 * sbql4jx.annotation.processing.ProcessingEnvironment annotation
 * processing}, the guarantees for "the same" implementation must
 * include contexts where the {@linkplain sbql4jx.annotation.processing
 * API mediated} side effects of {@linkplain
 * sbql4jx.annotation.processing.Processor processors} could be visible
 * to each other, including successive annotation processing
 * {@linkplain sbql4jx.annotation.processing.RoundEnvironment rounds}.
 *
 * @author Joseph D. Darcy
 * @author Scott Seligman
 * @author Peter von der Ah&eacute;
 * @see sbql4jx.lang.model.util.Elements#getName
 * @since 1.6
 */
