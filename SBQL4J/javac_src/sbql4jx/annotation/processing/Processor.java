...
package sbql4jx.annotation.processing;
 ...
 * sbql4jx.annotation.processing.RoundEnvironment rounds}.  On each
 ...
 * controlled.  For example, for a {@link sbql4jx.tools.JavaCompiler
 * JavaCompiler} the list of candidate processors to run can be
 * {@linkplain sbql4jx.tools.JavaCompiler.CompilationTask#setProcessors
 * set directly} or controlled by a {@linkplain
 * sbql4jx.tools.StandardLocation#ANNOTATION_PROCESSOR_PATH search path}
...
public interface Processor {
     ...
     * sbql4jx.lang.model.SourceVersion#isIdentifier identifiers}:
     *
     * <blockquote>
     * <dl>
     ...
     * @see sbql4jx.annotation.processing.SupportedOptions
     */
     ...
     * @see sbql4jx.annotation.processing.SupportedAnnotationTypes
     ...
     * processor.
     * @see sbql4jx.annotation.processing.SupportedSourceVersion
