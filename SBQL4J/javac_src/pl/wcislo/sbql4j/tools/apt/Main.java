...
package pl.wcislo.sbql4j.tools.apt;
...
public class Main {
    ...
    static {
        ...
        if (loader != null)
            loader.setPackageAssertionStatus("pl.wcislo.sbql4j.tools.apt", true);
    }
    ...
    private static int processing(AnnotationProcessorFactory factory,
        ...
        pl.wcislo.sbql4j.tools.apt.main.Main compiler =
            new pl.wcislo.sbql4j.tools.apt.main.Main("apt", out);
