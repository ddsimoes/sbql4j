...
import pl.wcislo.sbql4j.tools.apt.comp.Apt;
 ...
 */
public class JavaCompiler extends pl.wcislo.sbql4j.tools.javac.main.JavaCompiler {
    ...
    public JavaCompiler(Context context) {
        ...
        // for use by pl.wcislo.sbql4j.mirror.util.SourcePosition.
        lineDebugInfo = true;
    }
    ...
    public List<ClassSymbol> compile(List<String> filenames,
        ...
        try {
            ...
            for (List<String> l = filenames; l.nonEmpty(); l = l.tail) {
                if (classesAsDecls) {
                    if (! (l.head.endsWith(".java") || l.head.endsWith(".s4j")) ) { // process as class file
