...
package pl.wcislo.sbql4j.tools.apt.main;
...
import pl.wcislo.sbql4j.mirror.apt.AnnotationProcessorFactory;
import pl.wcislo.sbql4j.tools.apt.comp.AnnotationProcessingError;
import pl.wcislo.sbql4j.tools.apt.comp.UsageMessageNeededException;
...
public class Main {
    ...
    private Option[] recognizedOptions = {
        ...
        new HiddenOption("sourcefile") {
                ...
                boolean matches(String s) {
                    this.s = s;
                    return (s.endsWith(".java") || s.endsWith(".s4j")) ||
    ...
    public int compile(String[] args, AnnotationProcessorFactory factory) {
        ...
        if (options.get("-nocompile") == null &&
                    ...
                    if (matchPosition != -1) {
                        ...
                        if (op.aptOnly) {
                            ...
                            if ((options.get("-XclassesAsDecls") != null) &&
                                ...
                                if (! (args[i].endsWith(".java")) || args[i].endsWith(".s4j") ) {
                                    newArgsLength--;
                                    args[i] = null;
                                }
                            }
            ...
            returnCode = pl.wcislo.sbql4j.tools.javac.Main.compile(newArgs);
        }
    ...
    private static final String javacRB =
        "pl.wcislo.sbql4j.tools.javac.resources.javac";

    private static final String aptRB =
        "pl.wcislo.sbql4j.tools.apt.resources.apt";
