...
public abstract class ExecutableMemberDocImpl
     ...
     */
    public pl.wcislo.sbql4j.javadoc.Type[] thrownExceptionTypes() {
    ...
    /**
     * Get the mSignature. It is the parameter list, type is qualified.
    ...
    /**
     * Get flat mSignature.  All types are not qualified.
