...
import pl.wcislo.sbql4j.javadoc.WildcardType;
...
public class TypeMaker {
    ...
    public static pl.wcislo.sbql4j.javadoc.Type getType(DocEnv env, Type t) {
     ...
     */
    public static pl.wcislo.sbql4j.javadoc.Type[] getTypes(DocEnv env, List<Type> ts) {
        return getTypes(env, ts, new pl.wcislo.sbql4j.javadoc.Type[ts.length()]);
    }
     ...
     */
    public static pl.wcislo.sbql4j.javadoc.Type[] getTypes(DocEnv env, List<Type> ts,
                                                  pl.wcislo.sbql4j.javadoc.Type res[]) {
        int i = 0;
        for (Type t : ts) {
            res[i++] = getType(env, t);
        }
    ...
    private static class ArrayTypeImpl implements pl.wcislo.sbql4j.javadoc.Type {
        ...
        private pl.wcislo.sbql4j.javadoc.Type skipArraysCache = null;

        private pl.wcislo.sbql4j.javadoc.Type skipArrays() {
