...
public class MethodDocImpl
     ...
     * is a constructor.
     */
    public pl.wcislo.sbql4j.javadoc.Type returnType() {
    ...
    public ClassDoc overriddenClass() {
        pl.wcislo.sbql4j.javadoc.Type t = overriddenType();
     ...
     */
    public pl.wcislo.sbql4j.javadoc.Type overriddenType() {
    ...
    public MethodDoc overriddenMethod() {
        ...
        // Derived from  pl.wcislo.sbql4j.tools.javac.comp.Check.checkOverride .
     ...
     * qualified mSignature, the qualified method name, and any type
