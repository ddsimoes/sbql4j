...
public class TagletManager {
    ...
    private void checkTaglet(Object taglet) {
        ...
        } else if (taglet instanceof pl.wcislo.sbql4j.tools.doclets.Taglet) {
            pl.wcislo.sbql4j.tools.doclets.Taglet legacyTaglet = (pl.wcislo.sbql4j.tools.doclets.Taglet) taglet;
