...
import pl.wcislo.sbql4j.javadoc.LanguageVersion;
...
import pl.wcislo.sbql4j.tools.doclets.internal.toolkit.util.PackageListWriter;
...
public abstract class AbstractDoclet {
    ...
    private static final String TOOLKIT_DOCLET_NAME = new
        pl.wcislo.sbql4j.tools.doclets.formats.html.HtmlDoclet().getClass().getName();
