...
import pl.wcislo.sbql4j.tools.doclets.internal.toolkit.builders.MemberSummaryBuilder;
import pl.wcislo.sbql4j.tools.doclets.internal.toolkit.taglets.ParamTaglet;
...
public class ClassWriterImpl extends SubWriterHolderWriter
    ...
    public void writeClassSignature(String modifiers) {
        ...
        //Let's not link to ourselves in the mSignature.
        linkInfo.linkToSelf = false;
