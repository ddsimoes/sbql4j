...
import pl.wcislo.sbql4j.tools.javac.comp.Enter;
import pl.wcislo.sbql4j.tools.javac.comp.Env;
import pl.wcislo.sbql4j.tools.javac.comp.Flow;
import pl.wcislo.sbql4j.tools.javac.comp.Lower;
import pl.wcislo.sbql4j.tools.javac.comp.Todo;
import pl.wcislo.sbql4j.tools.javac.comp.TransTypes;
import pl.wcislo.sbql4j.tools.javac.jvm.ClassReader;
import pl.wcislo.sbql4j.tools.javac.jvm.ClassWriter;
import pl.wcislo.sbql4j.tools.javac.jvm.Gen;
import pl.wcislo.sbql4j.tools.javac.parser.DocCommentScanner;
import pl.wcislo.sbql4j.tools.javac.parser.Parser;
import pl.wcislo.sbql4j.tools.javac.parser.Scanner;
...
public class JavaCompiler implements ClassReader.SourceCompleter {
    ...
    private static final String versionRBName = "pl.wcislo.sbql4j.tools.javac.resources.version";
    ...
    JavaFileObject printSource(Env<AttrContext> env, JCClassDecl cdef) throws IOException {
        ...
        if (inputFiles.contains(outFile)) {
            ...
            try {
                new Pretty(out, true, CodeGeneratorFactory.createDefaultCodeGenerator()).printUnit(env.toplevel, cdef);
                if (verbose)
...
//      System.err.println("completing " + c);//DEBUG
   ...
   public List<JCCompilationUnit> parseFiles(List<JavaFileObject> fileObjects) throws IOException {
    ...
    public static void enableLogging() {
        Logger logger = Logger.getLogger(pl.wcislo.sbql4j.tools.javac.Main.class.getPackage().getName());
