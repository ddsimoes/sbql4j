...
package pl.wcislo.sbql4j.tools.javac.main;

import static pl.wcislo.sbql4j.tools.javac.main.OptionName.A;
import static pl.wcislo.sbql4j.tools.javac.main.OptionName.ATTRPARSEONLY;
import static pl.wcislo.sbql4j.tools.javac.main.OptionName.BOOTCLASSPATH;
import static pl.wcislo.sbql4j.tools.javac.main.OptionName.CLASSPATH;
import static pl.wcislo.sbql4j.tools.javac.main.OptionName.COMPLEXINFERENCE;
import static pl.wcislo.sbql4j.tools.javac.main.OptionName.CP;
import static pl.wcislo.sbql4j.tools.javac.main.OptionName.D;
import static pl.wcislo.sbql4j.tools.javac.main.OptionName.DEPRECATION;
import static pl.wcislo.sbql4j.tools.javac.main.OptionName.DJAVA_ENDORSED_DIRS;
import static pl.wcislo.sbql4j.tools.javac.main.OptionName.DJAVA_EXT_DIRS;
import static pl.wcislo.sbql4j.tools.javac.main.OptionName.DOE;
import static pl.wcislo.sbql4j.tools.javac.main.OptionName.ENCODING;
import static pl.wcislo.sbql4j.tools.javac.main.OptionName.ENDORSEDDIRS;
import static pl.wcislo.sbql4j.tools.javac.main.OptionName.EXTDIRS;
import static pl.wcislo.sbql4j.tools.javac.main.OptionName.FULLVERSION;
import static pl.wcislo.sbql4j.tools.javac.main.OptionName.G;
import static pl.wcislo.sbql4j.tools.javac.main.OptionName.G_CUSTOM;
import static pl.wcislo.sbql4j.tools.javac.main.OptionName.G_NONE;
import static pl.wcislo.sbql4j.tools.javac.main.OptionName.HELP;
import static pl.wcislo.sbql4j.tools.javac.main.OptionName.IMPLICIT;
import static pl.wcislo.sbql4j.tools.javac.main.OptionName.J;
import static pl.wcislo.sbql4j.tools.javac.main.OptionName.MOREINFO;
import static pl.wcislo.sbql4j.tools.javac.main.OptionName.NOWARN;
import static pl.wcislo.sbql4j.tools.javac.main.OptionName.O;
import static pl.wcislo.sbql4j.tools.javac.main.OptionName.PRINTSOURCE;
import static pl.wcislo.sbql4j.tools.javac.main.OptionName.PROCESSOR;
import static pl.wcislo.sbql4j.tools.javac.main.OptionName.PROCESSORPATH;
import static pl.wcislo.sbql4j.tools.javac.main.OptionName.PROC_CUSTOM;
import static pl.wcislo.sbql4j.tools.javac.main.OptionName.PROMPT;
import static pl.wcislo.sbql4j.tools.javac.main.OptionName.S;
import static pl.wcislo.sbql4j.tools.javac.main.OptionName.SOURCE;
import static pl.wcislo.sbql4j.tools.javac.main.OptionName.SOURCEFILE;
import static pl.wcislo.sbql4j.tools.javac.main.OptionName.SOURCEPATH;
import static pl.wcislo.sbql4j.tools.javac.main.OptionName.TARGET;
import static pl.wcislo.sbql4j.tools.javac.main.OptionName.VERBOSE;
import static pl.wcislo.sbql4j.tools.javac.main.OptionName.VERSION;
import static pl.wcislo.sbql4j.tools.javac.main.OptionName.WARNUNCHECKED;
import static pl.wcislo.sbql4j.tools.javac.main.OptionName.WERROR;
import static pl.wcislo.sbql4j.tools.javac.main.OptionName.X;
import static pl.wcislo.sbql4j.tools.javac.main.OptionName.XBOOTCLASSPATH;
import static pl.wcislo.sbql4j.tools.javac.main.OptionName.XBOOTCLASSPATH_APPEND;
import static pl.wcislo.sbql4j.tools.javac.main.OptionName.XBOOTCLASSPATH_PREPEND;
import static pl.wcislo.sbql4j.tools.javac.main.OptionName.XD;
import static pl.wcislo.sbql4j.tools.javac.main.OptionName.XJCOV;
import static pl.wcislo.sbql4j.tools.javac.main.OptionName.XLINT;
import static pl.wcislo.sbql4j.tools.javac.main.OptionName.XLINT_CUSTOM;
import static pl.wcislo.sbql4j.tools.javac.main.OptionName.XMAXERRS;
import static pl.wcislo.sbql4j.tools.javac.main.OptionName.XMAXWARNS;
import static pl.wcislo.sbql4j.tools.javac.main.OptionName.XPREFER;
import static pl.wcislo.sbql4j.tools.javac.main.OptionName.XPRINT;
import static pl.wcislo.sbql4j.tools.javac.main.OptionName.XPRINTPROCESSORINFO;
import static pl.wcislo.sbql4j.tools.javac.main.OptionName.XPRINTROUNDS;
import static pl.wcislo.sbql4j.tools.javac.main.OptionName.XSTDOUT;
...
import pl.wcislo.sbql4j.tools.javac.main.JavacOption.HiddenOption;
import pl.wcislo.sbql4j.tools.javac.main.JavacOption.Option;
import pl.wcislo.sbql4j.tools.javac.main.JavacOption.XOption;
import pl.wcislo.sbql4j.tools.javac.processing.JavacProcessingEnvironment;
...
/**
 * TODO: describe pl.wcislo.sbql4j.tools.javac.main.RecognizedOptions
 *
...
public class RecognizedOptions {
    ...
    public static Option[] getAll(final OptionHelper helper) {
        ...
        new HiddenOption(SOURCEFILE) {
            ...
            public boolean matches(String s) {
                this.s = s;
                return (s.endsWith(".java") || s.endsWith(".s4j"))  // Java source file
                    || SourceVersion.isName(s);   // Legal type name
            }
            public boolean process(Options options, String option) {
                if (s.endsWith(".java") || s.endsWith(".s4j")) {
                    File f = new File(s);
                    if (!f.exists()) {
