...
import static pl.wcislo.sbql4j.tools.javac.jvm.UninitializedType.UNINITIALIZED_OBJECT;
import static pl.wcislo.sbql4j.tools.javac.jvm.UninitializedType.UNINITIALIZED_THIS;
import static sbql4jx.tools.StandardLocation.CLASS_OUTPUT;
...
import sbql4jx.tools.FileObject;
 ...
 ******************************************************************/
    ...
    /** Assemble mSignature of given type in string buffer.
     */
    ...
    /** Return mSignature of given type
     */
 ...
 ******************************************************************/
    ...
    int writeMemberAttrs(Symbol sym) {
        ...
        if (source.allowGenerics() &&
            ...
            // will get a mSignature attribute
