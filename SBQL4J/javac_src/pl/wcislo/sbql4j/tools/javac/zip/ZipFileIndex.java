...
package pl.wcislo.sbql4j.tools.javac.zip;
...
public class ZipFileIndex {
     ...
     */
    public pl.wcislo.sbql4j.tools.javac.util.List<String> getFiles(String path) {
        if (File.separatorChar != '/') {
            path = path.replace('/', File.separatorChar);
        }
        ...
        try {
            ...
            pl.wcislo.sbql4j.tools.javac.util.List<String> ret = de == null ? null : de.getFiles();

            if (ret == null) {
                return pl.wcislo.sbql4j.tools.javac.util.List.<String>nil();
            }
            return ret;
        }
        catch (IOException e) {
    ...
    public List<String> getAllDirectories(String path) {
        ...
        try {
            ...
            DirectoryEntry de = directories.get(path);
            pl.wcislo.sbql4j.tools.javac.util.List<String> ret = de == null ? null : de.getDirectories();
   ...
   */
    ...
    static class DirectoryEntry {
        ...
        private pl.wcislo.sbql4j.tools.javac.util.List<String> zipFileEntriesFiles = pl.wcislo.sbql4j.tools.javac.util.List.<String>nil();
        private pl.wcislo.sbql4j.tools.javac.util.List<String> zipFileEntriesDirectories = pl.wcislo.sbql4j.tools.javac.util.List.<String>nil();
        private pl.wcislo.sbql4j.tools.javac.util.List<ZipFileIndexEntry>  zipFileEntries = pl.wcislo.sbql4j.tools.javac.util.List.<ZipFileIndexEntry>nil();
        ...
        private pl.wcislo.sbql4j.tools.javac.util.List<String> getFiles() {
            if (filesInited) {
        ...
        private pl.wcislo.sbql4j.tools.javac.util.List<String> getDirectories() {
        ...
        private pl.wcislo.sbql4j.tools.javac.util.List<ZipFileIndexEntry> getEntries() {
            ...
            zipFileEntries = pl.wcislo.sbql4j.tools.javac.util.List.nil();
