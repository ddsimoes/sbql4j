...
package pl.wcislo.sbql4j.tools.javac;
...
public class Main {
    ...
    static {
        ...
        if (loader != null)
            loader.setPackageAssertionStatus("pl.wcislo.sbql4j.tools.javac", true);
    }
    ...
    public static void main(String[] args) throws Exception {
      if (args.length > 0 && args[0].equals("-Xjdb")) {
        ...
        Class<?> c = Class.forName("pl.wcislo.sbql4j.tools.example.debug.tty.TTY");
        Method method = c.getDeclaredMethod ("main", new Class[] {args.getClass()});
        method.setAccessible(true);
        System.arraycopy(args, 1, newargs, 3, args.length - 1);
        newargs[0] = "-connect";
        newargs[1] = "pl.wcislo.sbql4j.jdi.CommandLineLaunch:options=-esa -ea:pl.wcislo.sbql4j.tools...";
        newargs[2] = "pl.wcislo.sbql4j.tools.javac.Main";
    ...
    public static int compile(String[] args) {
        pl.wcislo.sbql4j.tools.javac.main.Main compiler =
            new pl.wcislo.sbql4j.tools.javac.main.Main("javac");
    ...
    public static int compile(String[] args, PrintWriter out) {
        pl.wcislo.sbql4j.tools.javac.main.Main compiler =
            new pl.wcislo.sbql4j.tools.javac.main.Main("javac", out);
        return compiler.compile(args);
    }
}
