...
package pl.wcislo.sbql4j.tools.javac.sym;

import static sbql4jx.tools.JavaFileObject.Kind.CLASS;
...
import sbql4jx.annotation.processing.AbstractProcessor;
import sbql4jx.annotation.processing.RoundEnvironment;
import sbql4jx.annotation.processing.SupportedAnnotationTypes;
import sbql4jx.annotation.processing.SupportedOptions;
import sbql4jx.lang.model.SourceVersion;
import sbql4jx.lang.model.element.TypeElement;
import sbql4jx.tools.Diagnostic;
...
import sbql4jx.tools.ToolProvider;
 ...
 *
 * <dl>
 * <dt>pl.wcislo.sbql4j.tools.javac.sym.Jar</dt>
 * <dd>Specifies the location of rt.jar.</dd>
 * <dt>pl.wcislo.sbql4j.tools.javac.sym.Dest</dt>
 ...
 */
@SupportedOptions({"pl.wcislo.sbql4j.tools.javac.sym.Jar","pl.wcislo.sbql4j.tools.javac.sym.Dest"})
@SupportedAnnotationTypes("*")
public class CreateSymbols extends AbstractProcessor {

    static Set<String> getLegacyPackages() {
        ResourceBundle legacyBundle
            = ResourceBundle.getBundle("pl.wcislo.sbql4j.tools.javac.resources.legacy");
    ...
    void createSymbols() throws IOException {
        ...
        String jarName = processingEnv.getOptions().get("pl.wcislo.sbql4j.tools.javac.sym.Jar");
        if (jarName == null)
            throw new RuntimeException("Must use -Acom.sun.tools.javac.sym.Jar=LOCATION_OF_JAR");
        String destName = processingEnv.getOptions().get("pl.wcislo.sbql4j.tools.javac.sym.Dest");
        if (destName == null)
        ...
        pl.wcislo.sbql4j.tools.javac.main.JavaCompiler compiler =
            pl.wcislo.sbql4j.tools.javac.main.JavaCompiler.instance(task.getContext());
        ...
        for (JavaFileObject file : fm.list(jarLocation, "", EnumSet.of(CLASS), true)) {
            ...
            sym.complete();
            if (sym.getEnclosingElement().getKind() != sbql4jx.lang.model.element.ElementKind.PACKAGE) {
    ...
    public static void main(String... args) {
        ...
        args = new String[] {
            ...
            "-proc:only",
            "-processor",
            "pl.wcislo.sbql4j.tools.javac.sym.CreateSymbols",
            ...
            "org.xml.sax.ext",
            "org.xml.sax.helpers",
            "pl.wcislo.sbql4j.java.browser.dom",
            "org.w3c.dom",
            "org.w3c.dom.bootstrap",
            "org.w3c.dom.ls",
            "org.w3c.dom.ranges",
            ...
            "org.w3c.dom.events",
            "org.w3c.dom.views",
            "pl.wcislo.sbql4j.management",
            "pl.wcislo.sbql4j.security.auth",
            "pl.wcislo.sbql4j.security.auth.callback",
            "pl.wcislo.sbql4j.security.auth.login",
            "pl.wcislo.sbql4j.security.auth.module",
            "pl.wcislo.sbql4j.security.jgss",
            "pl.wcislo.sbql4j.net.httpserver",
            "pl.wcislo.sbql4j.net.httpserver.spi",
            "javax.smartcardio"
            // </editor-fold>
        };
        pl.wcislo.sbql4j.tools.javac.Main.compile(args);
    }
