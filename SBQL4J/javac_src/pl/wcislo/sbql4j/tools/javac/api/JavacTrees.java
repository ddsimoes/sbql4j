...
package pl.wcislo.sbql4j.tools.javac.api;

import java.io.IOException;
import java.util.Map;

import pl.wcislo.sbql4j.source.tree.CompilationUnitTree;
import pl.wcislo.sbql4j.source.tree.Scope;
import pl.wcislo.sbql4j.source.tree.Tree;
import pl.wcislo.sbql4j.source.util.SourcePositions;
import pl.wcislo.sbql4j.source.util.TreePath;
...
import pl.wcislo.sbql4j.tools.javac.tree.TreeCopier;
...
public class JavacTrees extends Trees {
    ...
    public boolean isAccessible(Scope scope, Element member, DeclaredType type) {
        if (scope instanceof JavacScope
                ...
                && type instanceof pl.wcislo.sbql4j.tools.javac.code.Type) {
            Env<AttrContext> env = ((JavacScope) scope).env;
            return resolve.isAccessible(env, (pl.wcislo.sbql4j.tools.javac.code.Type)type, (Symbol)member);
        } else
            return false;
    }
