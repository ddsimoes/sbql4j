...
import pl.wcislo.sbql4j.tools.javac.main.JavacOption.OptionKind;
import pl.wcislo.sbql4j.tools.javac.main.RecognizedOptions.GrumpyHelper;
...
/**
 * TODO: describe pl.wcislo.sbql4j.tools.javac.api.Tool
 *
...
public final class JavacTool implements JavaCompiler {
     ...
     * mechanism.
     * @see sbql4jx.tools.JavaCompilerTool
     * @see sbql4jx.tools.ToolProvider
     * @see #create
     */
    @Deprecated
    public JavacTool() {}
                             ...
                             Iterable<? extends JavaFileObject> compilationUnits)
    {
        ...
        if (compilationUnits != null) {
            for (JavaFileObject cu : compilationUnits) {
                if (cu.getKind() != JavaFileObject.Kind.SOURCE && cu.getKind() != JavaFileObject.Kind.SOURCE_SBQL4J) // implicit null check
    ...
    public int run(InputStream in, OutputStream out, OutputStream err, String... arguments) {
        ...
        return pl.wcislo.sbql4j.tools.javac.Main.compile(arguments, new PrintWriter(err, true));
    }
