...
import pl.wcislo.sbql4j.source.util.JavacTask;
...
import pl.wcislo.sbql4j.tools.javac.main.CommandLine;
import pl.wcislo.sbql4j.tools.javac.main.JavaCompiler;
import pl.wcislo.sbql4j.tools.javac.main.Main;
...
import pl.wcislo.sbql4j.tools.javac.util.ClientCodeException;
...
public class JavacTaskImpl extends JavacTask {
    ...
    public ListBuffer<Env<AttrContext>> getGenList() {
		return genList;
	}
    ...
    private void prepareCompiler() throws IOException {
        if (!used.getAndSet(true)) {
            ...
            pl.wcislo.sbql4j.tools.javac.parser.DocCommentScanner.Factory.preRegister(context);
    ...
    public Iterable<? extends Element> analyze(Iterable<? extends TypeElement> classes) throws IOException {
        ...
        for(SBQL4JStatement stmt : col.getStatements()) {
        	stmt.replaceViewDefinitions();
        }
        //--EW
        return results;
    }
