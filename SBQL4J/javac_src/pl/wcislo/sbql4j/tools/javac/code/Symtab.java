...
package pl.wcislo.sbql4j.tools.javac.code;

import static pl.wcislo.sbql4j.tools.javac.code.Flags.ACYCLIC;
...
import static pl.wcislo.sbql4j.tools.javac.code.Flags.HYPOTHETICAL;
import static pl.wcislo.sbql4j.tools.javac.code.Flags.INTERFACE;
import static pl.wcislo.sbql4j.tools.javac.code.Flags.PROTECTED;
import static pl.wcislo.sbql4j.tools.javac.code.Flags.PUBLIC;
import static pl.wcislo.sbql4j.tools.javac.code.Flags.STATIC;
import static pl.wcislo.sbql4j.tools.javac.jvm.ByteCodes.bool_and;
import static pl.wcislo.sbql4j.tools.javac.jvm.ByteCodes.bool_not;
import static pl.wcislo.sbql4j.tools.javac.jvm.ByteCodes.bool_or;
import static pl.wcislo.sbql4j.tools.javac.jvm.ByteCodes.dadd;
import static pl.wcislo.sbql4j.tools.javac.jvm.ByteCodes.dcmpg;
import static pl.wcislo.sbql4j.tools.javac.jvm.ByteCodes.dcmpl;
import static pl.wcislo.sbql4j.tools.javac.jvm.ByteCodes.ddiv;
import static pl.wcislo.sbql4j.tools.javac.jvm.ByteCodes.dmod;
import static pl.wcislo.sbql4j.tools.javac.jvm.ByteCodes.dmul;
import static pl.wcislo.sbql4j.tools.javac.jvm.ByteCodes.dneg;
import static pl.wcislo.sbql4j.tools.javac.jvm.ByteCodes.dsub;
import static pl.wcislo.sbql4j.tools.javac.jvm.ByteCodes.error;
import static pl.wcislo.sbql4j.tools.javac.jvm.ByteCodes.fadd;
import static pl.wcislo.sbql4j.tools.javac.jvm.ByteCodes.fcmpg;
import static pl.wcislo.sbql4j.tools.javac.jvm.ByteCodes.fcmpl;
import static pl.wcislo.sbql4j.tools.javac.jvm.ByteCodes.fdiv;
import static pl.wcislo.sbql4j.tools.javac.jvm.ByteCodes.fmod;
import static pl.wcislo.sbql4j.tools.javac.jvm.ByteCodes.fmul;
import static pl.wcislo.sbql4j.tools.javac.jvm.ByteCodes.fneg;
import static pl.wcislo.sbql4j.tools.javac.jvm.ByteCodes.fsub;
import static pl.wcislo.sbql4j.tools.javac.jvm.ByteCodes.iadd;
import static pl.wcislo.sbql4j.tools.javac.jvm.ByteCodes.iand;
import static pl.wcislo.sbql4j.tools.javac.jvm.ByteCodes.idiv;
import static pl.wcislo.sbql4j.tools.javac.jvm.ByteCodes.if_acmpeq;
import static pl.wcislo.sbql4j.tools.javac.jvm.ByteCodes.if_acmpne;
import static pl.wcislo.sbql4j.tools.javac.jvm.ByteCodes.if_icmpeq;
import static pl.wcislo.sbql4j.tools.javac.jvm.ByteCodes.if_icmpge;
import static pl.wcislo.sbql4j.tools.javac.jvm.ByteCodes.if_icmpgt;
import static pl.wcislo.sbql4j.tools.javac.jvm.ByteCodes.if_icmple;
import static pl.wcislo.sbql4j.tools.javac.jvm.ByteCodes.if_icmplt;
import static pl.wcislo.sbql4j.tools.javac.jvm.ByteCodes.if_icmpne;
import static pl.wcislo.sbql4j.tools.javac.jvm.ByteCodes.ifeq;
import static pl.wcislo.sbql4j.tools.javac.jvm.ByteCodes.ifge;
import static pl.wcislo.sbql4j.tools.javac.jvm.ByteCodes.ifgt;
import static pl.wcislo.sbql4j.tools.javac.jvm.ByteCodes.ifle;
import static pl.wcislo.sbql4j.tools.javac.jvm.ByteCodes.iflt;
import static pl.wcislo.sbql4j.tools.javac.jvm.ByteCodes.ifne;
import static pl.wcislo.sbql4j.tools.javac.jvm.ByteCodes.imod;
import static pl.wcislo.sbql4j.tools.javac.jvm.ByteCodes.imul;
import static pl.wcislo.sbql4j.tools.javac.jvm.ByteCodes.ineg;
import static pl.wcislo.sbql4j.tools.javac.jvm.ByteCodes.ior;
import static pl.wcislo.sbql4j.tools.javac.jvm.ByteCodes.ishl;
import static pl.wcislo.sbql4j.tools.javac.jvm.ByteCodes.ishll;
import static pl.wcislo.sbql4j.tools.javac.jvm.ByteCodes.ishr;
import static pl.wcislo.sbql4j.tools.javac.jvm.ByteCodes.ishrl;
import static pl.wcislo.sbql4j.tools.javac.jvm.ByteCodes.isub;
import static pl.wcislo.sbql4j.tools.javac.jvm.ByteCodes.iushr;
import static pl.wcislo.sbql4j.tools.javac.jvm.ByteCodes.iushrl;
import static pl.wcislo.sbql4j.tools.javac.jvm.ByteCodes.ixor;
import static pl.wcislo.sbql4j.tools.javac.jvm.ByteCodes.ladd;
import static pl.wcislo.sbql4j.tools.javac.jvm.ByteCodes.land;
import static pl.wcislo.sbql4j.tools.javac.jvm.ByteCodes.lcmp;
import static pl.wcislo.sbql4j.tools.javac.jvm.ByteCodes.ldiv;
import static pl.wcislo.sbql4j.tools.javac.jvm.ByteCodes.lmod;
import static pl.wcislo.sbql4j.tools.javac.jvm.ByteCodes.lmul;
import static pl.wcislo.sbql4j.tools.javac.jvm.ByteCodes.lneg;
import static pl.wcislo.sbql4j.tools.javac.jvm.ByteCodes.lor;
import static pl.wcislo.sbql4j.tools.javac.jvm.ByteCodes.lshl;
import static pl.wcislo.sbql4j.tools.javac.jvm.ByteCodes.lshll;
import static pl.wcislo.sbql4j.tools.javac.jvm.ByteCodes.lshr;
import static pl.wcislo.sbql4j.tools.javac.jvm.ByteCodes.lshrl;
import static pl.wcislo.sbql4j.tools.javac.jvm.ByteCodes.lsub;
import static pl.wcislo.sbql4j.tools.javac.jvm.ByteCodes.lushr;
import static pl.wcislo.sbql4j.tools.javac.jvm.ByteCodes.lushrl;
import static pl.wcislo.sbql4j.tools.javac.jvm.ByteCodes.lxor;
import static pl.wcislo.sbql4j.tools.javac.jvm.ByteCodes.nop;
import static pl.wcislo.sbql4j.tools.javac.jvm.ByteCodes.nullchk;
import static pl.wcislo.sbql4j.tools.javac.jvm.ByteCodes.string_add;

import java.util.HashMap;
import java.util.Map;

import pl.wcislo.sbql4j.tools.javac.code.Symbol.ClassSymbol;
import pl.wcislo.sbql4j.tools.javac.code.Symbol.Completer;
