...
import static pl.wcislo.sbql4j.tools.javac.code.Flags.ANONCONSTR;
...
import static pl.wcislo.sbql4j.tools.javac.code.Kinds.ABSENT_MTH;
import static pl.wcislo.sbql4j.tools.javac.code.Kinds.ABSENT_TYP;
import static pl.wcislo.sbql4j.tools.javac.code.Kinds.ABSENT_VAR;
...
import static pl.wcislo.sbql4j.tools.javac.code.Kinds.HIDDEN;
import static pl.wcislo.sbql4j.tools.javac.code.Kinds.MTH;
import static pl.wcislo.sbql4j.tools.javac.code.Kinds.PCK;
import static pl.wcislo.sbql4j.tools.javac.code.Kinds.STATICERR;
...
import static pl.wcislo.sbql4j.tools.javac.code.Kinds.WRONG_MTH;
import static pl.wcislo.sbql4j.tools.javac.code.Kinds.WRONG_MTHS;
...
import pl.wcislo.sbql4j.tools.javac.util.FatalError;
 ...
 ****************************************************************************/
    ...
    Symbol findVar(Env<AttrContext> env, Name name) {
    	//XXX metoda wyszukiwania zmiennych
        Symbol bestSoFar = varNotFound;
        Symbol sym;
    ...
    Symbol mostSpecific(Symbol m1,
        ...
        case MTH:
            ...
            if (m1SignatureMoreSpecific && m2SignatureMoreSpecific) {
                ...
                // same mSignature; select (a) the non-bridge method, or
...
//            if(encl.sym.type instanceof ClassType) {
//            	ClassType viewType = (ClassType)(encl.sym.type);	
//	            if(isClassViewDeclaration(viewType, env1) && viewType.viewInfo == null) {
//	            	Attr attr = Attr.instance(context);
//	            	JCViewInfoCollector viewInfoCollect = new JCViewInfoCollector(encl, (ClassType) viewType, attr);
//	            	ViewInfo vInfo = viewInfoCollect.analyseViewDeclaration();
//	            	viewType.viewInfo = vInfo;
//	            }
//            }
        }
...
//          printscopes(site.tsym.members());//DEBUG
    ...
    //ew
    public boolean isAccessible(Symbol sym,
                  DiagnosticPosition pos,
                  Type site,
                  Name name,
                  boolean qualified,
            ...
            if (name != name.table.error) {
                ...
                if (kind == WRONG_MTH) {
                    ...
                    if (site.tsym.kind == PCK && !site.tsym.exists())
                    	...
                    	//XXX tu jest logowanie bledu nie znaleziono nazwy
...
//where
    ...
    private boolean isClassViewDeclaration(ClassType type, Env<AttrContext> env) {
//    	if(ClassTypes.getInstance() == null) {
	    	JavaNameResolver jnr = new JavaNameResolver(this, env, -1, names);
	    	ClassTypes.initInstance(syms, names, jnr, types);
//    	}
    	return ViewAnalysisHelper.isClassViewDeclaration(type);
    }
}
