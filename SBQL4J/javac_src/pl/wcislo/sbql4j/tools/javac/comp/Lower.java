...
import pl.wcislo.sbql4j.tools.javac.jvm.ClassWriter;
...
import pl.wcislo.sbql4j.tools.javac.tree.TreeTranslator;
 ...
 *************************************************************************/
     ...
     *  @param sig      The mSignature of type T.
     */
    ...
    private JCExpression classOfType(Type type, DiagnosticPosition pos) {
        ...
        case CLASS: case ARRAY:
            ...
            // where
            //  - <tsig>  is the type mSignature of T,
