...
package pl.wcislo.sbql4j.tools.javac.tree;
...
import pl.wcislo.sbql4j.source.tree.AnnotationTree;
import pl.wcislo.sbql4j.source.tree.ArrayAccessTree;
import pl.wcislo.sbql4j.source.tree.ArrayTypeTree;
import pl.wcislo.sbql4j.source.tree.AssertTree;
import pl.wcislo.sbql4j.source.tree.AssignmentTree;
import pl.wcislo.sbql4j.source.tree.BinaryTree;
import pl.wcislo.sbql4j.source.tree.BlockTree;
import pl.wcislo.sbql4j.source.tree.BreakTree;
import pl.wcislo.sbql4j.source.tree.CaseTree;
import pl.wcislo.sbql4j.source.tree.CatchTree;
import pl.wcislo.sbql4j.source.tree.ClassTree;
import pl.wcislo.sbql4j.source.tree.CompilationUnitTree;
import pl.wcislo.sbql4j.source.tree.CompoundAssignmentTree;
import pl.wcislo.sbql4j.source.tree.ConditionalExpressionTree;
import pl.wcislo.sbql4j.source.tree.ContinueTree;
import pl.wcislo.sbql4j.source.tree.DoWhileLoopTree;
import pl.wcislo.sbql4j.source.tree.EmptyStatementTree;
import pl.wcislo.sbql4j.source.tree.EnhancedForLoopTree;
import pl.wcislo.sbql4j.source.tree.ExpressionStatementTree;
import pl.wcislo.sbql4j.source.tree.ExpressionTree;
import pl.wcislo.sbql4j.source.tree.ForLoopTree;
import pl.wcislo.sbql4j.source.tree.IdentifierTree;
import pl.wcislo.sbql4j.source.tree.IfTree;
import pl.wcislo.sbql4j.source.tree.ImportTree;
import pl.wcislo.sbql4j.source.tree.InstanceOfTree;
import pl.wcislo.sbql4j.source.tree.LabeledStatementTree;
import pl.wcislo.sbql4j.source.tree.LiteralTree;
import pl.wcislo.sbql4j.source.tree.MemberSelectTree;
import pl.wcislo.sbql4j.source.tree.MethodInvocationTree;
import pl.wcislo.sbql4j.source.tree.MethodTree;
import pl.wcislo.sbql4j.source.tree.NewArrayTree;
import pl.wcislo.sbql4j.source.tree.NewClassTree;
import pl.wcislo.sbql4j.source.tree.ParameterizedTypeTree;
import pl.wcislo.sbql4j.source.tree.ParenthesizedTree;
import pl.wcislo.sbql4j.source.tree.PrimitiveTypeTree;
import pl.wcislo.sbql4j.source.tree.ReturnTree;
import pl.wcislo.sbql4j.source.tree.StatementTree;
import pl.wcislo.sbql4j.source.tree.SwitchTree;
import pl.wcislo.sbql4j.source.tree.SynchronizedTree;
import pl.wcislo.sbql4j.source.tree.ThrowTree;
import pl.wcislo.sbql4j.source.tree.Tree;
import pl.wcislo.sbql4j.source.tree.TreeVisitor;
import pl.wcislo.sbql4j.source.tree.TryTree;
import pl.wcislo.sbql4j.source.tree.TypeCastTree;
import pl.wcislo.sbql4j.source.tree.TypeParameterTree;
import pl.wcislo.sbql4j.source.tree.UnaryTree;
import pl.wcislo.sbql4j.source.tree.VariableTree;
import pl.wcislo.sbql4j.source.tree.WhileLoopTree;
import pl.wcislo.sbql4j.source.tree.WildcardTree;
...
import sbql4jx.lang.model.element.Modifier;
 ...
 *
 * <p>Except for the methods defined by pl.wcislo.sbql4j.source, the only
 ...
 * Tree.
 *
 * <p>To avoid ambiguities with the Tree API in pl.wcislo.sbql4j.source all sub
...
public abstract class JCTree implements Tree, Cloneable, DiagnosticPosition {
    ...
    public String toString() {
        ...
        try {
            new Pretty(s, false, CodeGeneratorFactory.createDefaultCodeGenerator()).printExpr(this);
        }
        catch (IOException e) {
    ...
    public static class JCIdent extends JCExpression implements IdentifierTree {
        public Name name;
        public Symbol sym;
        public JCIdent(Name name, Symbol sym) {
            this.name = name;
            this.sym = sym;
        }
        @Override
    ...
    public static class JCModifiers extends JCTree implements pl.wcislo.sbql4j.source.tree.ModifiersTree {
        public long flags;
     ...
     *
     */
    public static class JCSbqlExpression extends JCExpression {
    	public boolean attrVisited = false;
    	public boolean viewQuery = false;
        public List<JCAnnotation> annotations;
        public String expr;
        public Expression exprTree;
        public java.util.List<Symbol.VarSymbol> localVarContext = new ArrayList<Symbol.VarSymbol>();
        public java.util.List<Symbol.ClassSymbol> localClassContext = new ArrayList<Symbol.ClassSymbol>();
        public java.util.List<Symbol.PackageSymbol> localPackageContext = new ArrayList<Symbol.PackageSymbol>();
        public JavaNameResolver usedJNR;
        public Signature resultType;
        public boolean resultIsAssigned;
        public ClassType enclosingClass;
        public SBQL4JStatement stmt;
        
        protected JCSbqlExpression(List<JCAnnotation> annotations, String expr) {
            this.annotations = annotations;
            this.expr = expr;
            this.stmt = new SBQL4JStatement(expr, this.pos);
        }
        
        @Override
        public void accept(Visitor v) { v.visitSbqlExpression(this); }
        ...
        @Override
        public <R,D> R accept(TreeVisitor<R,D> v, D d) {
            return v.visitSbqlExpression(this, d);
        }
        @Override
        public int getTag() {
            return APPLY;
    ...
    public static class JCErroneous extends JCExpression
            implements pl.wcislo.sbql4j.source.tree.ErroneousTree {
    ...
    public interface Factory {
        ...
        JCSbqlExpression SbqlExpression(List<JCAnnotation> annotations, String expr);
    ...
    public static abstract class Visitor {
        ...
        public void visitSbqlExpression(JCSbqlExpression that) { visitTree(that); }
