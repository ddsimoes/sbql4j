...
import static pl.wcislo.sbql4j.tools.javac.parser.Token.CHARLITERAL;
import static pl.wcislo.sbql4j.tools.javac.parser.Token.COMMA;
import static pl.wcislo.sbql4j.tools.javac.parser.Token.DOT;
import static pl.wcislo.sbql4j.tools.javac.parser.Token.DOUBLELITERAL;
...
import static pl.wcislo.sbql4j.tools.javac.parser.Token.FLOATLITERAL;
...
import static pl.wcislo.sbql4j.tools.javac.parser.Token.SLASH;
import static pl.wcislo.sbql4j.tools.javac.parser.Token.SLASHEQ;
import static pl.wcislo.sbql4j.tools.javac.parser.Token.STRINGLITERAL;
import static pl.wcislo.sbql4j.tools.javac.util.LayoutCharacters.CR;
import static pl.wcislo.sbql4j.tools.javac.util.LayoutCharacters.EOI;
import static pl.wcislo.sbql4j.tools.javac.util.LayoutCharacters.FF;
import static pl.wcislo.sbql4j.tools.javac.util.LayoutCharacters.LF;
...
import pl.wcislo.sbql4j.tools.javac.util.JavacFileManager;
...
public class Scanner implements Lexer {
	private static final org.apache.commons.logging.Log logger = LogFactory.getLog(Lexer.class);
        ...
        try {
            ...
            while (true) {
                ...
                case '\"':
                    ...
                    return;
                case '#':
                    scanChar(); token = Token.HASH; return;
                default:
                    if (isSpecial(ch)) {
                        scanOperator();
                    } else {
