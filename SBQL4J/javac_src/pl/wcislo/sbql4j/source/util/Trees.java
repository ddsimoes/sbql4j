...
public abstract class Trees {
    ...
    public static Trees instance(CompilationTask task) {
        if (!task.getClass().getName().equals("pl.wcislo.sbql4j.tools.javac.api.JavacTaskImpl"))
    ...
    public static Trees instance(ProcessingEnvironment env) {
        if (!env.getClass().getName().equals("pl.wcislo.sbql4j.tools.javac.processing.JavacProcessingEnvironment"))
            throw new IllegalArgumentException();
    ...
    private static Trees getJavacTrees(Class<?> argType, Object arg) {
        try {
            ...
            Class<?> c = Class.forName("pl.wcislo.sbql4j.tools.javac.api.JavacTrees", false, cl);
