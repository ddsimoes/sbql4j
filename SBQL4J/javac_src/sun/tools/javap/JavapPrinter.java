...
import static sun.tools.javap.RuntimeConstants.CONSTANT_CLASS;
import static sun.tools.javap.RuntimeConstants.CONSTANT_DOUBLE;
import static sun.tools.javap.RuntimeConstants.CONSTANT_FIELD;
import static sun.tools.javap.RuntimeConstants.CONSTANT_INTERFACEMETHOD;
import static sun.tools.javap.RuntimeConstants.CONSTANT_LONG;
import static sun.tools.javap.RuntimeConstants.CONSTANT_METHOD;
import static sun.tools.javap.RuntimeConstants.CONSTANT_NAMEANDTYPE;
import static sun.tools.javap.RuntimeConstants.CONSTANT_STRING;
import static sun.tools.javap.RuntimeConstants.ITEM_NewObject;
import static sun.tools.javap.RuntimeConstants.ITEM_Object;
import static sun.tools.javap.RuntimeConstants.T_BOOLEAN;
import static sun.tools.javap.RuntimeConstants.T_BYTE;
import static sun.tools.javap.RuntimeConstants.T_CHAR;
import static sun.tools.javap.RuntimeConstants.T_CLASS;
import static sun.tools.javap.RuntimeConstants.T_DOUBLE;
import static sun.tools.javap.RuntimeConstants.T_FLOAT;
import static sun.tools.javap.RuntimeConstants.T_INT;
import static sun.tools.javap.RuntimeConstants.T_LONG;
import static sun.tools.javap.RuntimeConstants.T_SHORT;
import static sun.tools.javap.RuntimeConstants.opc_aload;
import static sun.tools.javap.RuntimeConstants.opc_anewarray;
import static sun.tools.javap.RuntimeConstants.opc_astore;
import static sun.tools.javap.RuntimeConstants.opc_bipush;
import static sun.tools.javap.RuntimeConstants.opc_checkcast;
import static sun.tools.javap.RuntimeConstants.opc_dload;
import static sun.tools.javap.RuntimeConstants.opc_dstore;
import static sun.tools.javap.RuntimeConstants.opc_fload;
import static sun.tools.javap.RuntimeConstants.opc_fstore;
import static sun.tools.javap.RuntimeConstants.opc_getfield;
import static sun.tools.javap.RuntimeConstants.opc_getstatic;
import static sun.tools.javap.RuntimeConstants.opc_goto;
import static sun.tools.javap.RuntimeConstants.opc_goto_w;
import static sun.tools.javap.RuntimeConstants.opc_if_acmpeq;
import static sun.tools.javap.RuntimeConstants.opc_if_acmpne;
import static sun.tools.javap.RuntimeConstants.opc_if_icmpeq;
import static sun.tools.javap.RuntimeConstants.opc_if_icmpge;
import static sun.tools.javap.RuntimeConstants.opc_if_icmpgt;
import static sun.tools.javap.RuntimeConstants.opc_if_icmple;
import static sun.tools.javap.RuntimeConstants.opc_if_icmplt;
import static sun.tools.javap.RuntimeConstants.opc_if_icmpne;
import static sun.tools.javap.RuntimeConstants.opc_ifeq;
import static sun.tools.javap.RuntimeConstants.opc_ifge;
import static sun.tools.javap.RuntimeConstants.opc_ifgt;
import static sun.tools.javap.RuntimeConstants.opc_ifle;
import static sun.tools.javap.RuntimeConstants.opc_iflt;
import static sun.tools.javap.RuntimeConstants.opc_ifne;
import static sun.tools.javap.RuntimeConstants.opc_ifnonnull;
import static sun.tools.javap.RuntimeConstants.opc_ifnull;
import static sun.tools.javap.RuntimeConstants.opc_iinc;
import static sun.tools.javap.RuntimeConstants.opc_iload;
import static sun.tools.javap.RuntimeConstants.opc_instanceof;
import static sun.tools.javap.RuntimeConstants.opc_invokeinterface;
import static sun.tools.javap.RuntimeConstants.opc_invokespecial;
import static sun.tools.javap.RuntimeConstants.opc_invokestatic;
import static sun.tools.javap.RuntimeConstants.opc_invokevirtual;
import static sun.tools.javap.RuntimeConstants.opc_istore;
import static sun.tools.javap.RuntimeConstants.opc_jsr;
import static sun.tools.javap.RuntimeConstants.opc_jsr_w;
import static sun.tools.javap.RuntimeConstants.opc_ldc;
import static sun.tools.javap.RuntimeConstants.opc_ldc2_w;
import static sun.tools.javap.RuntimeConstants.opc_ldc_w;
import static sun.tools.javap.RuntimeConstants.opc_lload;
import static sun.tools.javap.RuntimeConstants.opc_lookupswitch;
import static sun.tools.javap.RuntimeConstants.opc_lstore;
import static sun.tools.javap.RuntimeConstants.opc_multianewarray;
import static sun.tools.javap.RuntimeConstants.opc_new;
import static sun.tools.javap.RuntimeConstants.opc_newarray;
import static sun.tools.javap.RuntimeConstants.opc_nonpriv;
import static sun.tools.javap.RuntimeConstants.opc_priv;
import static sun.tools.javap.RuntimeConstants.opc_putfield;
import static sun.tools.javap.RuntimeConstants.opc_putstatic;
import static sun.tools.javap.RuntimeConstants.opc_ret;
import static sun.tools.javap.RuntimeConstants.opc_sipush;
import static sun.tools.javap.RuntimeConstants.opc_tableswitch;
import static sun.tools.javap.RuntimeConstants.opc_wide;
    ...
    public void printMethods(){
        ...
        for(int m = 0; m < methods.length; m++){
            ...
            if(checkAccess(accflags)){
                ...
                // Print internal mSignature of method.
                if (env.showInternalSigs){
