...
public class KORQueries_SbqlQuery36 {
    private com.db4o.ObjectContainer dbConn;
    private java.lang.String nazwadruzyny;

    public KORQueries_SbqlQuery36(final com.db4o.ObjectContainer dbConn,
    ...
    /**
     * original query='dbConn.(count(Mecz where druzyna.nazwa == nazwadruzyny))'
     *
     * query after optimization='dbConn.( count((Mecz where getDruzyna().getNazwa() == nazwadruzyny)))'
    */
    public java.lang.Integer executeQuery() {
        com.db4o.ObjectContainer _ident_dbConn = dbConn;
        java.lang.Integer _queryResult = _ident_dbConn.query(new KORQueries_SbqlQuery36Db4o0(
                    nazwadruzyny));
