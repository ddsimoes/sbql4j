...
public class KORQueries_SbqlQuery10 {
    private com.db4o.ObjectContainer dbConn;

    public KORQueries_SbqlQuery10(final com.db4o.ObjectContainer dbConn) {
        this.dbConn = dbConn;
    }

    /**
     * original query='dbConn.(count(Mecz))'
     *
     * query after optimization='dbConn.( count(Mecz))'
    */
    public java.lang.Integer executeQuery() {
        com.db4o.ObjectContainer _ident_dbConn = dbConn;
        java.lang.Integer _queryResult = _ident_dbConn.query(new KORQueries_SbqlQuery10Db4o0());
