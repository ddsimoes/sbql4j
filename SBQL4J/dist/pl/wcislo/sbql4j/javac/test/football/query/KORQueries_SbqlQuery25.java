...
public class KORQueries_SbqlQuery25 {
    private com.db4o.ObjectContainer dbConn;

    public KORQueries_SbqlQuery25(final com.db4o.ObjectContainer dbConn) {
        this.dbConn = dbConn;
    }

    /**
     * original query='dbConn.(Oboz)'
     *
     * query after optimization='dbConn.Oboz'
    */
    public java.util.Collection<pl.wcislo.sbql4j.javac.test.football.model.Oboz> executeQuery() {
        ...
        java.util.Collection<pl.wcislo.sbql4j.javac.test.football.model.Oboz> _queryResult =
            _ident_dbConn.query(new KORQueries_SbqlQuery25Db4o0());
