...
public class KORQueries_SbqlQuery19 {
    private com.db4o.ObjectContainer dbConn;

    public KORQueries_SbqlQuery19(final com.db4o.ObjectContainer dbConn) {
        this.dbConn = dbConn;
    }

    /**
     * original query='dbConn.(( Druzyna as druzyna )
     ...
     *
     * query after optimization='dbConn.(PilkarzMecz as pm group as _aux0).(Druzyna as druzyna join  sum (_aux0 where pm.getPilkarz() in druzyna.getLista_zawodnikow()).(pm.getLiczba_zoltych_kartek() + pm.getLiczba_czerwonych_kartek()) as liczbakartek)'
    */
    public java.util.Collection<pl.wcislo.sbql4j.java.model.runtime.Struct> executeQuery() {
        ...
        java.util.Collection<pl.wcislo.sbql4j.java.model.runtime.Struct> _queryResult =
            _ident_dbConn.query(new KORQueries_SbqlQuery19Db4o0());
