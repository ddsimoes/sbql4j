...
public class KORQueries_SbqlQuery17 {
    private com.db4o.ObjectContainer dbConn;

    public KORQueries_SbqlQuery17(final com.db4o.ObjectContainer dbConn) {
        this.dbConn = dbConn;
    }

    /**
     * original query='dbConn.(unique(Mecz.nazwa_stadionu))'
     *
     * query after optimization='dbConn.( unique Mecz.getNazwa_stadionu())'
    */
    public java.util.Collection<java.lang.String> executeQuery() {
        com.db4o.ObjectContainer _ident_dbConn = dbConn;
        java.util.Collection<java.lang.String> _queryResult = _ident_dbConn.query(new KORQueries_SbqlQuery17Db4o0());
