...
public class KORQueries_SbqlQuery16Db4o0 implements Db4oSbqlQuery {
    private java.lang.String nazwadruzyny;

    public KORQueries_SbqlQuery16Db4o0(java.lang.String nazwadruzyny) {
        this.nazwadruzyny = nazwadruzyny;
    }

    /**
     * query='dbConn.(Mecz where getDruzyna2().getNazwa() == nazwadruzyny).getWynik()'
    '
     **/
    public java.util.Collection<java.lang.String> executeQuery(
        ...
        for (long _id20 : _ids20) {
            ...
            _ident_Mecz.add((pl.wcislo.sbql4j.javac.test.football.model.Mecz) _ref20.getObject());
        }
