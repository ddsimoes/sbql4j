...
public class KORQueries_SbqlQuery18 {
    private com.db4o.ObjectContainer dbConn;
    private java.lang.String nazwast;

    public KORQueries_SbqlQuery18(final com.db4o.ObjectContainer dbConn,
        final java.lang.String nazwast) {
        this.dbConn = dbConn;
        this.nazwast = nazwast;
    }

    /**
     * original query='dbConn.((Mecz where nazwa_stadionu==nazwast).(wynik))'
     *
     * query after optimization='dbConn.(Mecz where getNazwa_stadionu() == nazwast).getWynik()'
    */
    public java.util.Collection<java.lang.String> executeQuery() {
        com.db4o.ObjectContainer _ident_dbConn = dbConn;
        java.util.Collection<java.lang.String> _queryResult = _ident_dbConn.query(new KORQueries_SbqlQuery18Db4o0(
                    nazwast));
