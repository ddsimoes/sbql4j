...
public class KORQueries_SbqlQuery1 {
    private com.db4o.ObjectContainer dbConn;
    private java.lang.String ut;

    public KORQueries_SbqlQuery1(final com.db4o.ObjectContainer dbConn,
        final java.lang.String ut) {
        this.dbConn = dbConn;
        this.ut = ut;
    }

    /**
     * original query='dbConn.((Pilkarz as d where d.nazwisko==ut ) order by d.druzyna.nazwa)'
     *
     * query after optimization='dbConn.((Pilkarz as d where d.getNazwisko() == ut) order by (d.getDruzyna().getNazwa()))'
    */
    public java.util.List<pl.wcislo.sbql4j.javac.test.football.model.Pilkarz> executeQuery() {
        ...
        java.util.List<pl.wcislo.sbql4j.javac.test.football.model.Pilkarz> _queryResult =
            _ident_dbConn.query(new KORQueries_SbqlQuery1Db4o0(ut));
