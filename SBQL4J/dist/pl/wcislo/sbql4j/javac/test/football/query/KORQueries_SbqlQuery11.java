...
public class KORQueries_SbqlQuery11 {
    private com.db4o.ObjectContainer dbConn;

    public KORQueries_SbqlQuery11(final com.db4o.ObjectContainer dbConn) {
        this.dbConn = dbConn;
    }

    /**
     * original query='dbConn.(count(unique(Mecz.nazwa_stadionu)))'
     *
     * query after optimization='dbConn.( count( unique Mecz.getNazwa_stadionu()))'
    */
    public java.lang.Integer executeQuery() {
        com.db4o.ObjectContainer _ident_dbConn = dbConn;
        java.lang.Integer _queryResult = _ident_dbConn.query(new KORQueries_SbqlQuery11Db4o0());
