...
public class KORQueries_SbqlQuery28 {
    private com.db4o.ObjectContainer dbConn;

    public KORQueries_SbqlQuery28(final com.db4o.ObjectContainer dbConn) {
        this.dbConn = dbConn;
    }

    /**
     * original query='dbConn.((Zabieg as zabiegi)
            join (Pilkarz as pilkarz where zabiegi.pilkarz ==pilkarz))'
     *
     * query after optimization='dbConn.(Pilkarz as pilkarz group as _aux0).(Zabieg as zabiegi join (zabiegi.getPilkarz() group as _aux1).(_aux0 where _aux1 == pilkarz))'
    */
    public java.util.Collection<pl.wcislo.sbql4j.java.model.runtime.Struct> executeQuery() {
        ...
        java.util.Collection<pl.wcislo.sbql4j.java.model.runtime.Struct> _queryResult =
            _ident_dbConn.query(new KORQueries_SbqlQuery28Db4o0());
