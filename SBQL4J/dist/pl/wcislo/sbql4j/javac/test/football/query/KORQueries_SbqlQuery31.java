...
public class KORQueries_SbqlQuery31 {
    private com.db4o.ObjectContainer dbConn;

    public KORQueries_SbqlQuery31(final com.db4o.ObjectContainer dbConn) {
        this.dbConn = dbConn;
    }
     ...
     *
     * query after optimization='dbConn.(Druzyna as d where  avg(d.getLista_zawodnikow().getWiek()) > 20 and  avg(d.getLista_zawodnikow().getWiek()) < 40 and  exists d.getLista_zawodnikow().getKontuzja())'
    */
    public java.util.Collection<pl.wcislo.sbql4j.javac.test.football.model.Druzyna> executeQuery() {
        ...
        java.util.Collection<pl.wcislo.sbql4j.javac.test.football.model.Druzyna> _queryResult =
            _ident_dbConn.query(new KORQueries_SbqlQuery31Db4o0());
