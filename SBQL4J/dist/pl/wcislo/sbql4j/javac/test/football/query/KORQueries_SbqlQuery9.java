...
public class KORQueries_SbqlQuery9 {
    private com.db4o.ObjectContainer dbConn;

    public KORQueries_SbqlQuery9(final com.db4o.ObjectContainer dbConn) {
        this.dbConn = dbConn;
    }

    /**
     * original query='dbConn.((count(Mecz) as m
     ...
     *
     * query after optimization='dbConn.( sum PilkarzMecz.getLiczba_czerwonych_kartek() as lss group as _aux0).(( sum PilkarzMecz.getLiczba_zoltych_kartek() as ls group as _aux1).( count(Mecz) as m join _aux1) join _aux0).((ls/ m) as liczbazoltychkartek, (lss/ m) as liczbaczerwonychkartek)'
    */
    public pl.wcislo.sbql4j.java.model.runtime.Struct executeQuery() {
        com.db4o.ObjectContainer _ident_dbConn = dbConn;
        pl.wcislo.sbql4j.java.model.runtime.Struct _queryResult = _ident_dbConn.query(new KORQueries_SbqlQuery9Db4o0());
