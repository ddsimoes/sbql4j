...
public class KORQueries_SbqlQuery1Db4o0 implements Db4oSbqlQuery {
    private java.lang.String ut;

    public KORQueries_SbqlQuery1Db4o0(java.lang.String ut) {
        this.ut = ut;
    }

    /**
     * query='dbConn.((Pilkarz as d where d.getNazwisko() == ut) order by (d.getDruzyna().getNazwa()))'
    '
     **/
    public java.util.List<pl.wcislo.sbql4j.javac.test.football.model.Pilkarz> executeQuery(
        ...
        for (long _id1 : _ids1) {
            ...
            _ident_Pilkarz.add((pl.wcislo.sbql4j.javac.test.football.model.Pilkarz) _ref1.getObject());
        }
        ...
        for (pl.wcislo.sbql4j.javac.test.football.model.Pilkarz _whereEl : _asResult_d) {
            ...
            java.lang.String _mth_getNazwiskoResult = _dotEl.getNazwisko();
            ...
            java.lang.Boolean _equalsResult = OperatorUtils.equalsSafe(_mth_getNazwiskoResult,
                    _ident_ut);
        ...
        Comparator<pl.wcislo.sbql4j.javac.test.football.model.Pilkarz> _comparator1 =
        ...
        Collections.sort(_orderByResult, _comparator1);
