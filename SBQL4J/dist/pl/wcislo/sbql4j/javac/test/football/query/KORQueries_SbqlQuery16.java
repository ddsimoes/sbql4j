...
public class KORQueries_SbqlQuery16 {
    private com.db4o.ObjectContainer dbConn;
    private java.lang.String nazwadruzyny;

    public KORQueries_SbqlQuery16(final com.db4o.ObjectContainer dbConn,
    ...
    /**
     * original query='dbConn.((Mecz where druzyna2.nazwa == nazwadruzyny).(wynik))'
     *
     * query after optimization='dbConn.(Mecz where getDruzyna2().getNazwa() == nazwadruzyny).getWynik()'
    */
    public java.util.Collection<java.lang.String> executeQuery() {
        com.db4o.ObjectContainer _ident_dbConn = dbConn;
        java.util.Collection<java.lang.String> _queryResult = _ident_dbConn.query(new KORQueries_SbqlQuery16Db4o0(
                    nazwadruzyny));
