...
public class KORQueries_SbqlQuery13 {
    private com.db4o.ObjectContainer dbConn;
    private java.lang.String druzyna1;

    public KORQueries_SbqlQuery13(final com.db4o.ObjectContainer dbConn,
    ...
    /**
     * original query='dbConn.((Mecz   where druzyna2.nazwa == druzyna1).(wynik))'
     *
     * query after optimization='dbConn.(Mecz where getDruzyna2().getNazwa() == druzyna1).getWynik()'
    */
    public java.util.Collection<java.lang.String> executeQuery() {
        com.db4o.ObjectContainer _ident_dbConn = dbConn;
        java.util.Collection<java.lang.String> _queryResult = _ident_dbConn.query(new KORQueries_SbqlQuery13Db4o0(
                    druzyna1));
