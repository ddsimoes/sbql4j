...
public class KORQueries_SbqlQuery26 {
    private com.db4o.ObjectContainer dbConn;
    private java.lang.String nazwadruzyny;

    public KORQueries_SbqlQuery26(final com.db4o.ObjectContainer dbConn,
    ...
    /**
     * original query='dbConn.(exists(Oboz as o)
            join (Druzyna as d where d.nazwa==nazwadruzyny))'
     *
     * query after optimization='dbConn.((Druzyna as d where d.getNazwa() == nazwadruzyny) group as _aux0).( exists (Oboz as o) join _aux0)'
    */
    public java.util.Collection<pl.wcislo.sbql4j.java.model.runtime.Struct> executeQuery() {
        ...
        java.util.Collection<pl.wcislo.sbql4j.java.model.runtime.Struct> _queryResult =
            _ident_dbConn.query(new KORQueries_SbqlQuery26Db4o0(nazwadruzyny));
