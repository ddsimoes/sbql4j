...
public class KORQueries_SbqlQuery4 {
    private com.db4o.ObjectContainer dbConn;
    private java.lang.String u;

    public KORQueries_SbqlQuery4(final com.db4o.ObjectContainer dbConn,
    ...
    /**
     * original query='dbConn.(Druzyna where nazwa == u)'
     *
     * query after optimization='dbConn.(Druzyna where getNazwa() == u)'
    */
    public java.util.Collection<pl.wcislo.sbql4j.javac.test.football.model.Druzyna> executeQuery() {
        ...
        java.util.Collection<pl.wcislo.sbql4j.javac.test.football.model.Druzyna> _queryResult =
            _ident_dbConn.query(new KORQueries_SbqlQuery4Db4o0(u));
