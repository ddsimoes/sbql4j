...
public class KORQueries_SbqlQuery12Db4o0 implements Db4oSbqlQuery {
    private java.lang.String druzyna1;

    public KORQueries_SbqlQuery12Db4o0(java.lang.String druzyna1) {
        this.druzyna1 = druzyna1;
    }

    /**
     * query='dbConn.(Mecz where getDruzyna().getNazwa() == druzyna1).getWynik()'
    '
     **/
    public java.util.Collection<java.lang.String> executeQuery(
        ...
        for (long _id16 : _ids16) {
            ...
            _ident_Mecz.add((pl.wcislo.sbql4j.javac.test.football.model.Mecz) _ref16.getObject());
        }
