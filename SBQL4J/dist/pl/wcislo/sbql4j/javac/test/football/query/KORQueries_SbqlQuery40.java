...
public class KORQueries_SbqlQuery40 {
    private com.db4o.ObjectContainer dbConn;

    public KORQueries_SbqlQuery40(final com.db4o.ObjectContainer dbConn) {
        this.dbConn = dbConn;
    }

    /**
     * original query='dbConn.(Mecz.druzyna)'
     *
     * query after optimization='dbConn.Mecz.getDruzyna()'
    */
    public java.util.Collection<pl.wcislo.sbql4j.javac.test.football.model.Druzyna> executeQuery() {
        ...
        java.util.Collection<pl.wcislo.sbql4j.javac.test.football.model.Druzyna> _queryResult =
            _ident_dbConn.query(new KORQueries_SbqlQuery40Db4o0());
