...
public class KORQueries_SbqlQuery24 {
    private com.db4o.ObjectContainer dbConn;

    public KORQueries_SbqlQuery24(final com.db4o.ObjectContainer dbConn) {
        this.dbConn = dbConn;
    }

    /**
     * original query='dbConn.(Druzyna.nazwa)'
     *
     * query after optimization='dbConn.Druzyna.getNazwa()'
    */
    public java.util.Collection<java.lang.String> executeQuery() {
        com.db4o.ObjectContainer _ident_dbConn = dbConn;
        java.util.Collection<java.lang.String> _queryResult = _ident_dbConn.query(new KORQueries_SbqlQuery24Db4o0());
