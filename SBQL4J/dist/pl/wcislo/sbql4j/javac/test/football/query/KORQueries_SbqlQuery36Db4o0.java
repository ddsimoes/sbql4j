...
public class KORQueries_SbqlQuery36Db4o0 implements Db4oSbqlQuery {
    private java.lang.String nazwadruzyny;

    public KORQueries_SbqlQuery36Db4o0(java.lang.String nazwadruzyny) {
    ...
    public java.lang.Integer executeQuery(final ObjectContainerBase ocb,
        ...
        for (long _id50 : _ids50) {
            ...
            _ident_Mecz.add((pl.wcislo.sbql4j.javac.test.football.model.Mecz) _ref50.getObject());
        }
