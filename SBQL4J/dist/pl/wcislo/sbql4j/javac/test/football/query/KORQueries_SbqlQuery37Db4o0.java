...
public class KORQueries_SbqlQuery37Db4o0 implements Db4oSbqlQuery {
    private java.lang.String nazwadruzyny2;

    public KORQueries_SbqlQuery37Db4o0(java.lang.String nazwadruzyny2) {
        this.nazwadruzyny2 = nazwadruzyny2;
    }

    /**
     * query='dbConn.( count((Mecz where getDruzyna().getNazwa() == nazwadruzyny2)))'
    '
     **/
    public java.lang.Integer executeQuery(final ObjectContainerBase ocb,
        ...
        for (long _id51 : _ids51) {
            ...
            _ident_Mecz.add((pl.wcislo.sbql4j.javac.test.football.model.Mecz) _ref51.getObject());
        }
