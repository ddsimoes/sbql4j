...
public class KORQueries_SbqlQuery17Db4o0 implements Db4oSbqlQuery {
    public KORQueries_SbqlQuery17Db4o0() {
    }

    /**
     * query='dbConn.( unique Mecz.getNazwa_stadionu())'
    '
     **/
    public java.util.Collection<java.lang.String> executeQuery(
        ...
        for (long _id21 : _ids21) {
            ...
            _ident_Mecz.add((pl.wcislo.sbql4j.javac.test.football.model.Mecz) _ref21.getObject());
        }
