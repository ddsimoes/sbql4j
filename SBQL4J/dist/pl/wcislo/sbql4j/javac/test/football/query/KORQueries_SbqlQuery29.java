...
public class KORQueries_SbqlQuery29 {
    private com.db4o.ObjectContainer dbConn;

    public KORQueries_SbqlQuery29(final com.db4o.ObjectContainer dbConn) {
        this.dbConn = dbConn;
    }
     ...
     *
     * query after optimization='dbConn.( all Druzyna as d  any d.getLista_zawodnikow() as e e.getPremia() == 0)'
    */
    public java.lang.Boolean executeQuery() {
        com.db4o.ObjectContainer _ident_dbConn = dbConn;
        java.lang.Boolean _queryResult = _ident_dbConn.query(new KORQueries_SbqlQuery29Db4o0());
