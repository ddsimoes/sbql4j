...
public class KORQueries_SbqlQuery34 {
    private com.db4o.ObjectContainer dbConn;

    public KORQueries_SbqlQuery34(final com.db4o.ObjectContainer dbConn) {
        this.dbConn = dbConn;
    }

    /**
     * original query='dbConn.(PilkarzMecz where ilosc_goli == 5)'
     *
     * query after optimization='dbConn.(PilkarzMecz where getIlosc_goli() == 5)'
    */
    public java.util.Collection<pl.wcislo.sbql4j.javac.test.football.model.PilkarzMecz> executeQuery() {
        ...
        java.util.Collection<pl.wcislo.sbql4j.javac.test.football.model.PilkarzMecz> _queryResult =
            _ident_dbConn.query(new KORQueries_SbqlQuery34Db4o0());
