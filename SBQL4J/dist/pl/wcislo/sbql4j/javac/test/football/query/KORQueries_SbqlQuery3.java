...
public class KORQueries_SbqlQuery3 {
    private com.db4o.ObjectContainer dbConn;

    public KORQueries_SbqlQuery3(final com.db4o.ObjectContainer dbConn) {
        this.dbConn = dbConn;
    }

    /**
     * original query='dbConn.((Pilkarz as d) order by d.druzyna.nazwa)'
     *
     * query after optimization='dbConn.(Pilkarz as d order by (d.getDruzyna().getNazwa()))'
    */
    public java.util.List<pl.wcislo.sbql4j.javac.test.football.model.Pilkarz> executeQuery() {
        ...
        java.util.List<pl.wcislo.sbql4j.javac.test.football.model.Pilkarz> _queryResult =
            _ident_dbConn.query(new KORQueries_SbqlQuery3Db4o0());
