...
public class KORQueries_SbqlQuery27 {
    private com.db4o.ObjectContainer dbConn;
    private java.lang.String nazwadruzyny;

    public KORQueries_SbqlQuery27(final com.db4o.ObjectContainer dbConn,
    ...
    /**
     * original query='dbConn.((Stroj as s)
            join (Druzyna as d where d.nazwa == nazwadruzyny))'
     *
     * query after optimization='dbConn.((Druzyna as d where d.getNazwa() == nazwadruzyny) group as _aux0).(Stroj as s join _aux0)'
    */
    public java.util.Collection<pl.wcislo.sbql4j.java.model.runtime.Struct> executeQuery() {
        ...
        java.util.Collection<pl.wcislo.sbql4j.java.model.runtime.Struct> _queryResult =
            _ident_dbConn.query(new KORQueries_SbqlQuery27Db4o0(nazwadruzyny));
