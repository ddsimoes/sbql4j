...
public class TList {
    ...
    void run() {
        ...
        // 6351336: pl.wcislo.sbql4j.tools.javac.util.List shouldn't extend java.util.AbstractList
        test_AbstractList();

        // general unit tests for java.util.List methods, including...
        // 6389198: pl.wcislo.sbql4j.tools.javac.util.List.equals() violates java.util.List.equals() contract
        test_add_E();
        test_add_int_E();
    ...
    static <T> pl.wcislo.sbql4j.tools.javac.util.List<T> createList(List<T> d) {
        pl.wcislo.sbql4j.tools.javac.util.List<T> l = pl.wcislo.sbql4j.tools.javac.util.List.nil();
        for (ListIterator<T> iter = d.listIterator(d.size()); iter.hasPrevious(); )
            l = l.prepend(iter.previous());
        return l;
    }

    static <T> pl.wcislo.sbql4j.tools.javac.util.List<T> createList(T... d) {
        pl.wcislo.sbql4j.tools.javac.util.List<T> l = pl.wcislo.sbql4j.tools.javac.util.List.nil();
