...
public class VersionOpt {
    ...
    void run() throws Exception {
        ...
        Class<?> javacClass = pl.wcislo.sbql4j.tools.javac.Main.class;
        ...
        pl.wcislo.sbql4j.tools.javac.Main.compile(new String[] { "-version" }, new PrintWriter(sw));
        String javacVersion = sw.toString().trim();

        sw = new StringWriter();
        pl.wcislo.sbql4j.tools.javac.Main.compile(new String[] { "-fullversion" }, new PrintWriter(sw));
