...
public abstract class JavadocTester {
     ...
     * The default doclet.
     */
    public static final String DEFAULT_DOCLET_CLASS = "pl.wcislo.sbql4j.tools.doclets.formats.html.HtmlDoclet";
    public static final String DEFAULT_DOCLET_CLASS_OLD = "pl.wcislo.sbql4j.tools.doclets.standard.Standard";
    ...
    public int runJavadoc(String docletClass, String[] args) {
        ...
        int returnCode = pl.wcislo.sbql4j.tools.javadoc.Main.execute(
                getBugName(),
