 ...
 */
public class JviPilot implements CheckSummable
{
	 ...
	 */
	public JviPilot(String name, int points)
	{
		this.mName=name;
		this.mPoints=points;
	}
	 ...
	 * Full ctor.
	 */ 
	public JviPilot( String name, String frontname, int points, int licenseID )
	{
		mName		= name;
