 ...
 */
public class JviIndexedPilot implements CheckSummable
{
	 ...
	 */
	public JviIndexedPilot(String name, int points)
	{
		this.mName=name;
		this.mPoints=points;
	}
	 ...
	 * Full ctor.
	 */ 
	public JviIndexedPilot( String name, String frontname, int points, int licenseID )
	{
		mName		= name;
