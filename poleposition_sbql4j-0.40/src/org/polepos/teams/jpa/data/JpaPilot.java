 ...
 */
@Entity
public class JpaPilot implements CheckSummable
{
	 ...
	 */
	public JpaPilot(String name, int points)
	{
		this.mName=name;
		this.mPoints=points;
	}
	 ...
	 * Full ctor.
	 */ 
	public JpaPilot( String name, String frontname, int points, int licenseID )
	{
		mName		= name;
