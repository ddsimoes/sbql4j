...
/**
 * This is a patched version of the file that does not set autocommit
 * back to true on passivateObject. See the comment "Patched" further
 * down in the code.
 */
    ...
    public void passivateObject(Object obj) throws Exception {
        if(obj instanceof Connection) {
            ...
            if(!conn.getAutoCommit()) {
            	...
            	// Patched: 
            	// We don't set autocommit to true when
